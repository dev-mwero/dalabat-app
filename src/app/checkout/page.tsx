  ...
  return (
    <div className="bg-surface text-on-surface antialiased min-h-screen">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="flex-1 space-y-12">
            <div className="space-y-2">
              <h1 className="text-4xl font-extrabold tracking-tight text-on-surface leading-tight">Complete your order</h1>
              <p className="text-on-surface-variant body-md">Review your details and confirm your artisanal selection.</p>
            </div>

            <section className="space-y-6">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-surface-container-high flex items-center justify-center text-primary font-bold">1</div>
                <h2 className="text-xl font-bold tracking-tight">Delivery Method</h2>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <label className={`relative flex cursor-pointer rounded-xl p-6 focus:outline-none transition-colors ${deliveryMethod === "pickup" ? "bg-surface-container-lowest border-2 border-primary" : "bg-surface-container-low hover:bg-surface-container-high border-2 border-transparent"}`}>
                  ...
                  <div className="flex flex-col">
                    <span className="block text-sm font-bold text-on-surface flex items-center gap-2"><MapPin className="w-4 h-4" /> Pickup</span>
                    <span className="mt-1 flex items-center text-xs text-on-surface-variant">Collect from vendor location</span>
                    <span className="mt-6 text-sm font-bold text-primary">Free</span>
                  </div>
                ...
                {vendor?.deliveryAvailable && (
                  <label className={`relative flex cursor-pointer rounded-xl p-6 focus:outline-none transition-colors ${deliveryMethod === "delivery" ? "bg-surface-container-lowest border-2 border-primary" : "bg-surface-container-low hover:bg-surface-container-high border-2 border-transparent"}`}>
                    ...
                    <div className="flex flex-col">
                      <span className="block text-sm font-bold text-on-surface flex items-center gap-2"><Truck className="w-4 h-4" /> Delivery</span>
                      <span className="mt-1 flex items-center text-xs text-on-surface-variant">Delivered to your address</span>
                      <span className="mt-6 text-sm font-bold text-primary">{currency.format(vendor.deliveryFee)}</span>
                    </div>
              ...
              {deliveryMethod === "delivery" && (
                ...
                >
                  ...
                  <div className="bg-surface-container-low p-8 rounded-xl">
                    <div className="space-y-2">
                      <label className="text-sm font-semibold text-on-surface-variant block px-1">Full Address</label>
                      <input 
                        type="text" 
                        value={address}
            ...
            <section className="space-y-6">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-surface-container-high flex items-center justify-center text-primary font-bold">2</div>
                <h2 className="text-xl font-bold tracking-tight">Payment Information</h2>
              </div>
              
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <label className={`relative flex cursor-pointer rounded-xl p-4 focus:outline-none transition-colors ${paymentMethod === "cash" ? "bg-surface-container-lowest border-2 border-primary" : "bg-surface-container-low hover:bg-surface-container-high border-2 border-transparent"}`}>
                  ...
                  <div className="flex flex-col items-center justify-center w-full gap-2 text-center">
                    <Banknote className={`w-6 h-6 ${paymentMethod === "cash" ? "text-primary" : "text-on-surface-variant"}`} />
                    <span className="block text-sm font-bold text-on-surface">Cash</span>
                  </div>
                </label>
                <label className={`relative flex cursor-pointer rounded-xl p-4 focus:outline-none transition-colors ${paymentMethod === "mpesa-auto" ? "bg-surface-container-lowest border-2 border-primary" : "bg-surface-container-low hover:bg-surface-container-high border-2 border-transparent"}`}>
                  <input type="radio" name="payment" value="mpesa-auto" checked={paymentMethod === "mpesa-auto"} onChange={() => setPaymentMethod("mpesa-auto")} className="sr-only" />
                  <div className="flex flex-col items-center justify-center w-full gap-2 text-center">
                    <Phone className={`w-6 h-6 ${paymentMethod === "mpesa-auto" ? "text-primary" : "text-on-surface-variant"}`} />
                    <span className="block text-sm font-bold text-on-surface">M-Pesa (Auto)</span>
                  </div>
                </label>
                <label className={`relative flex cursor-pointer rounded-xl p-4 focus:outline-none transition-colors ${paymentMethod === "mpesa-manual" ? "bg-surface-container-lowest border-2 border-primary" : "bg-surface-container-low hover:bg-surface-container-high border-2 border-transparent"}`}>
                  <input type="radio" name="payment" value="mpesa-manual" checked={paymentMethod === "mpesa-manual"} onChange={() => setPaymentMethod("mpesa-manual")} className="sr-only" />
                  <div className="flex flex-col items-center justify-center w-full gap-2 text-center">
                    <Phone className={`w-6 h-6 ${paymentMethod === "mpesa-manual" ? "text-primary" : "text-on-surface-variant"}`} />
                    <span className="block text-sm font-bold text-on-surface">M-Pesa (Manual)</span>
                  </div>
                </label>
              </div>
              ...
              <AnimatePresence>
                {(paymentMethod === "mpesa-auto" || paymentMethod === "mpesa-manual") && (
                  ...
                  >
                    <div className="space-y-2">
                      <label className="text-sm font-semibold text-on-surface-variant block px-1">Phone Number</label>
                      <input 
                        type="text" 
                        value={phone}
                    ...
                    {paymentMethod === "mpesa-manual" && (
                      <div className="space-y-2">
                        <label className="text-sm font-semibold text-on-surface-variant block px-1">M-Pesa Transaction Code</label>
                        <input 
                          type="text" 
                          value={mpesaCode}
            ...
            <div className="lg:sticky lg:top-28 space-y-6">
              <div className="bg-surface-container-lowest rounded-2xl p-8 shadow-sm ring-1 ring-outline-variant/10">
                  ...
                  {items.map((item: any) => (
                    <div key={item.product._id} className="flex gap-4">
                      ...
                      <div className="flex flex-col justify-center">
                        ...
                        <p className="text-sm font-bold text-primary mt-2">{currency.format(item.product.price * item.quantity)}</p>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="space-y-4 pt-6 border-t border-outline-variant/10">
                  ...
                  <div className="flex justify-between text-sm text-on-surface-variant">
                    <span>Delivery</span>
                    <span>{deliveryFee > 0 ? currency.format(deliveryFee) : "Free"}</span>
                  </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-surface-container-low p-4 rounded-xl flex flex-col items-center justify-center text-center">
                  ...
                  <span className="text-[10px] font-bold uppercase leading-none mt-1">Verified Vendors</span>
                </div>
                <div className="bg-surface-container-low p-4 rounded-xl flex flex-col items-center justify-center text-center">
                  <Truck className="text-primary w-5 h-5 mb-1" />
                  <span className="text-[10px] font-bold uppercase leading-none mt-1">Fast Delivery</span>
                </div>
                <div className="bg-surface-container-low p-4 rounded-xl flex flex-col items-center justify-center text-center">
                  <Banknote className="text-primary w-5 h-5 mb-1" />
                  <span className="text-[10px] font-bold uppercase leading-none mt-1">Secure Payment</span>
                </div>
              </div>
            </div>
          </aside>
      ...
      <footer className="py-12 px-6 border-t border-outline-variant/10 text-center">
        <p className="text-sm text-on-surface-variant">© {new Date().getFullYear()} Zest Marketplace. All transactions are encrypted.</p>
      </footer>
    </div>
  );
}
